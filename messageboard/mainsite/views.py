...
def tableview(request):
    ...
    # Get all ids of subscribed topics for equality checking in html
    ...
    topic_notsublist = topic_list.exclude(id__in=subscribed_ids)
    topic_list = chain(topic_sublist, topic_notsublist)
